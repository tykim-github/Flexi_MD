...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  */
    ...
    PA7     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = RTC_SPI_NSS_Pin|RTC_SPI_SCK_Pin|RTC_SPI_MISO_Pin|RTC_SPI_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = LED_DRV_SPI_SCK_Pin|LED_DRV_SPI_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_SPI3;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, RTC_SPI_NSS_Pin|RTC_SPI_SCK_Pin|RTC_SPI_MISO_Pin|RTC_SPI_MOSI_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, LED_DRV_SPI_SCK_Pin|LED_DRV_SPI_MISO_Pin);
